...
import 'package:monalyse_ui_test/app/types/errors/network_error.dart';
...
NetworkError getErrorFromDioError(DioException error) {
  ...
  switch (error.type) {
    ...
    case DioExceptionType.badCertificate:
      networkExceptions = NetworkError.badCertificate();
      break;
    case DioExceptionType.connectionError:
      networkExceptions = const NetworkError.connectionError();
      break;
  }
