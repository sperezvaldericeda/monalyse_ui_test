...
import 'package:monalyse_ui_test/app/types/errors/network_error_utils.dart';
...
class NetworkError with _$NetworkError {
  ...
  const factory NetworkError.badCertificate() = _BadCertificate;

  const factory NetworkError.connectionError() = _ConnectionError;
